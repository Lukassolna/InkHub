...
export default function WritersResult(props) {
  ...
  function homeTextACB() {
    props.model.searchname = props.model.searchWriter;
  }

  return (
    <WritersResultView
      writerNames={props.model.searchedWriters}
      writerClick={chooseWriterACB}
      oldSearch={props.model.searchWriter}
