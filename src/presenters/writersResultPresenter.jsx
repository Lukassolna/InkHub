...
function WritersResult(props){
    ...
    function doSearchACB(){props.model.searchWriters(props.model.searchname) 
    //window.location.hash="#/results"
    }
 


    return <WritersResultView writerNames = {props.model.searchedWriters} writerClick={chooseWriterACB} oldSearch = {props.model.searchWriter}
