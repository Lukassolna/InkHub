...
export default function HomePageView(props) {
  function randomWritersCB(writer) {
    ...
    return (
      <div class="writer-container" onClick={writerClickACB}>
        <tr>
          <img
            class="writeritem"
    ...
    <span class="centerflex">
      <div class="header-container">
        <div class="logo-container">
          <img
            class="hide-bg mainlogo"
            src={
              "https://live.staticflickr.com/65535/53399465685_478bf306bd_b.jpg"
            }
            height={400}
            alt="Logo"
          ></img>
      ...
      <div class="centerflexsmall">
        <table>
          <div class="search-container">
            ...
            <div>
              <button
                disabled={props.currentOption === 1}
                class="oval-button"
              ...
              <button
                disabled={props.currentOption === 2}
                class="oval-button"
                onClick={writersButton}
              >
                Writers
              </button>
            </div>
          ...
          <tr>
            <div class="writerrow">
              {props.randomWriters.map(randomWritersCB)}
            </div>
          </tr>
        </table>
      </div>
